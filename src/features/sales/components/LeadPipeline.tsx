...
import { Clock, ChevronRight, MoreHorizontal, FileText, CheckCircle2, Send, Loader2, Calendar, X } from 'lucide-react';
    ...
    try {
      ...
      if (result.success) {
        toast.success("Follow-up Scheduled", {
          description: "Project moved to Follow Up tab and task scheduled successfully."
        });
              ...
              {colLeads.slice(0, visibleLimits[col.id]).map((lead) => {
                ...
                >
                  <div className="absolute top-0 right-0 p-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    {isLead && (
                      <div className="p-1.5 hover:bg-white/10 rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-7">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex gap-3 pt-1">
                    ...
                    >
                      {isSavingFollowUp ? <Loader2 className="w-4 h-4 animate-spin" /> : "Save Follow Up"}
                    </button>
                  </div>
                </div>
              </div>
