...
export default function IDCardClient({ profile: initialProfile, companySettings }: { profile: any, companySettings: any }) {
   ...
   const [editData] = useState({
      ...
      companyEmail: companySettings.email ?? DEFAULT_COMPANY_SETTINGS.email,
      companyWebsite: companySettings.website ?? DEFAULT_COMPANY_SETTINGS.website,
      companyAddress: `${companySettings.address ?? DEFAULT_COMPANY_SETTINGS.address}, ${companySettings.cityStateZip ?? DEFAULT_COMPANY_SETTINGS.cityStateZip}`,
   });
            ...
            <div className="flex flex-col gap-2 relative z-10 mt-2">
               <div className="flex gap-3.5 items-center">
                  ...
                  <div>
                     ...
                     <p className="text-[10px] text-slate-650 font-semibold leading-relaxed pr-2">{editData.companyAddress}</p>
                  </div>
               </div>
               <div className="flex gap-3.5 items-center">
               ...
               <div className="flex gap-3.5 items-center">
                  ...
                  <div>
                     ...
                     <p className="text-[11px] text-[#0c2e5c] font-bold font-sans">{editData.companyWebsite}</p>
                  </div>
               </div>
            </div>
