...
export function SearchableSelect({ 
  ...
  const dropdown = open ? (
    <div 
      ...
      className="mt-2 w-full min-w-[16rem] rounded-xl border border-slate-200/80 dark:border-white/10 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl shadow-xl shadow-slate-100/40 dark:shadow-black/40 animate-in fade-in slide-in-from-top-2 duration-150 overflow-hidden"
    >
